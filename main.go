...
func getTemp(v LassSensor)float32 {
    if v.Temperature > 0{
...
func getBaro(v LassSensor)float32 {
    if v.S_b2 > 0{
        return v.S_b2
    }else if v.S_b0 > 0{
        return v.S_b0
...
func getpm1(v LassSensor)float32 {
    if v.Pm1 > 0{
        return v.Pm1
    }else{
        return 0.0
...
func getpm10(v LassSensor)float32 {
    if v.Pm10 > 0{
        return v.Pm10
    }else{
        return 0.0
...
func getpm25(v LassSensor)float32 {
    if v.S_d0 > 0{
        return v.S_d0
    }else if v.Pm25 > 0{
        return v.Pm25
...
func gethum(v LassSensor)float32 {
    if v.Humidity > 0{
        return v.Humidity
    }else if v.S_h0 > 0{
        return v.S_h0
...
func getsate(v LassSensor)float32 {
    if v.Satellites > 0{
        return v.Satellites
    }else{
        return 0.0
...
func getvol(v LassSensor)float32 {
    if v.Voltage > 0{
        return v.Voltage
    }else{
        return 0.0
...
func getJson(url string, id uint8){
    ...
    for _, v := range m{
        ...
        res.Temperature = getTemp(v)
        res.Barometer = getBaro(v) 
        res.Pm1 = getpm1(v)
        res.Pm25 = getpm25(v)
        res.Pm10 = getpm10(v)
        res.Humidity = gethum(v)
        res.Satellites = getsate(v)
        res.Voltage = getvol(v)
